/*
  This sketch runs on the "Mini Pocket Radio" sold on Aliexpress.
 ...
 Mini Pocket Radio
  ...
  Further modified by Andrew KI7FXL, Feb 2025
*/
#include <Arduino.h>
#include <Wire.h>
#include <TFT_eSPI.h>
...
#define AUDIO_MUTE    3           // GPIO17
#define PIN_AMP_ENABLE 10
...
#define ESP32_I2C_SCL 17           // GPIO44
...
Band band[] = {
    {"FM ", FM_BAND_TYPE, 6400, 10800, 88900, 1, 0},
    {"AM ", MW_BAND_TYPE, 540, 1700, 810, 3, 4},
    {"CB ", SW_BAND_TYPE, 26000, 28000, 27500, 0, 4},
    {"ALL", SW_BAND_TYPE, 150, 30000, 15000, 5, 4}, // All band. LW, MW and SW (from 150kHz to 30MHz)

    {"80M", SW_BAND_TYPE, 3500, 4000, 3573, 0, 4},
    {"40M", SW_BAND_TYPE, 6500, 7300, 7100, 0, 4},
    {"30M", SW_BAND_TYPE, 10100, 10150, 10133, 0, 4},
    {"20M", SW_BAND_TYPE, 14000, 14350, 14200, 0, 4},
    {"17M", SW_BAND_TYPE, 18068, 18168, 18074, 0, 4},
    {"15M", SW_BAND_TYPE, 20000, 21400, 21100, 0, 4},
    {"12M", SW_BAND_TYPE, 24890, 24990, 24915, 0, 4},
...
void setup()
{
  ...
  digitalWrite(PIN_AMP_ENABLE, LOW);  // disable amp until setup complete
...
*/
  ...
  useBand();
  digitalWrite(PIN_AMP_ENABLE, HIGH);  // turn on audio
